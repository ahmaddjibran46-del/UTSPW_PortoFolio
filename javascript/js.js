...
if (profilForm) {
    profilForm.addEventListener("submit", function (e) {
        ...
        window.location.href = "profil-tampil.html";
    });
}

const profilResult = document.getElementById("profilResult");
